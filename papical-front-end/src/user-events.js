export default [
  ...
  {
    'title': 'Conference',
    'start': new Date(2019, 7, 11),
    'end': new Date(2019, 7, 13),
    desc: 'Big conference for important people'
  },
  {
    'title': 'Meeting',
    'start': new Date(2019, 7, 12, 10, 30, 0, 0),
    'end': new Date(2019, 7, 12, 12, 30, 0, 0),
  ...
  {
    'title': 'Happy Hour',
    'start': new Date(2019, 7, 12, 17, 0, 0, 0),
    'end': new Date(2019, 7, 12, 17, 30, 0, 0),
    desc: 'Most important meal of the day'
  },
  {
    'title': 'Dinner',
    'start': new Date(2019, 7, 12, 20, 0, 0, 0),
    'end': new Date(2019, 7, 21, 0, 0, 0)
  },
  {
